...
The entire package lives in a single file: `flywrite-mode.el`. The design spec is in `spec.md`. Sample files in `samples/` are used for manual end-to-end testing in Emacs.
